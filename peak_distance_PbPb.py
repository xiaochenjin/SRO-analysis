...
BC_CN_list=[[2.77,2.81],[2.78,2.82],[2.78,2.87]]
BC_NN2_list=[[4.05,4.16],[4.05,4.20],[3.9,4.27]]
BC_NN3_list=[[4.55,4.79],[4.57,4.89],[4.36,4.95]]
...
#	width=num2_info[3]
	...
	os.chdir(anal_conc)
	with open("data_neighbor_energy_PbPb.txt","w") as f1:
		cf = 0
		for i in index:
	...
	with open("data_neighbor_distance_PbPb.txt","w") as f1:
		cf = 0
		for i in index:
	...
	with open("neighbor_distance_PbPb.txt","w") as f1:
