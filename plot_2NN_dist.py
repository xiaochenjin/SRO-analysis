...
#	file_name = "{}_NN2.txt".format(bond)
...
#				sro_list.append(sro)
	...
	sro_list = ['0x0x0x0x0x0x0x0x0x0x6x8x2','0x0x0x0x0x0x0x0x0x1x3x11x1','0x0x0x0x0x0x0x0x0x2x0x14x0']
	title_list = ['distribution 1','distribution 2','distribution 3 (target)']
	sro_list_new = []
	sro_list_int = []
...
#		title = str(bond)+'-NN2-'+index_list[i]
		plt.title(title_list[i],weight = 'bold',fontsize='13')
